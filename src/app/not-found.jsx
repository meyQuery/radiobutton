  ...
  return (
    <main className="relative flex h-full items-center py-36 lg:px-8">
      ...
      <div className="relative mx-auto flex w-full max-w-2xl flex-col items-center px-4 sm:px-6 lg:px-0">
        <p className="text-sm leading-7 text-slate-500">404</p>
        ...
        <Link
          href="/"
          className="mt-4 text-sm font-semibold leading-6 text-pink-500 hover:text-pink-700 active:text-pink-900"
        >
          Go back home
        </Link>
      </div>
